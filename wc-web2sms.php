    ...
    public static function web2smsGetSettings() {
        $settings = array(
            'section_title' => array(
                    ...
                    'type'     => 'title',
                    'desc'     => __('Platforma web2sms a luat naștere în 2003 și este cel mai mare jucător de pe piața de marketing direct prin SMS din România. 
                    Este disponibilă pe orice browser și nu există cost suplimentar de licențiere. <br><br>Fiind singurul jucător de pe piața de marketing direct prin 
                    SMS conectat direct cu toți operatorii de telefonie mobilă, web2sms s-a făcut remarcat rapid prin: încredere, performanță, 
                    acces simplu din orice web browser și raportare clară. <br><br> Transparența este unul dintre diferențiatorii care fac din web2sms principalul jucător pe piața 
                    de marketing prin SMS din România. Pachetele noastre disponibile la https://www.web2sms.ro/oferta/ reflectă dedicarea noastră pentru a ajuta orice 
                    companie, indiferent de mărime, să fie mai aproape de clienții săi.<br><br>Activează pluginul simplu și în câțiva pași conform setărilor de mai jos. 
                    Pentru mai multe informații <a href="#" id="show_documention">vezi documentația</a>.', 'web-2-sms' ),
            ...
            'apikey' => array(
                    ...
                    'desc_tip'    => 'Inserează API Key-ul disponibil în contul tău web2sms',
                    'type'        => 'text',
            ...
            'secretkey' => array(
                    ...
                    'desc_tip'    => __('Inserează Secret Key-ul disponibil în contul tău web2sms', 'web-2-sms' ),
                    'type'        => 'text',
            ...
            'pending_sms_content' => array(
                    'name'        => __('Comanda in așteptare', 'web-2-sms' ),
                    'placeholder' => '',
                    'desc_tip'    => __('Textul SMS pe care clientul tău îl va primi când comanda lui are starea: În așteptare', 'web-2-sms' ),
                    'type'        => 'textarea',
                    'desc'        => __('Scrie textul SMS-ului care se va trimite atunci cand o comanda este in stare "așteptare"', 'web-2-sms' ),
            ...
            'pending' => array(
                    ...
                    'type'       => 'checkbox',
                    'desc'       => __('Bifeaza pentru trimiterea SMS daca o comanda este in starea "așteptare".', 'web-2-sms' ),
                    'id'         => 'wc_settings_web2sms_pending_status',
                    'default'    => 'no',
                    'css'        => '',
            ),
            'onhold_sms_content' => array(
                    'name'        => __('Comanda in On-Hold', 'web-2-sms' ),
                    'placeholder' => '',
                    'desc_tip'    => __('Textul SMS pe care clientul tău îl va primi când comanda lui are starea: On-Hold', 'web-2-sms' ),
                    'type'        => 'textarea',
            ...
            'failed_sms_content'  => array(
                    'name'        => __('Comanda eșuată', 'web-2-sms' ),
                    'placeholder' => '',
                    'desc_tip'    => __('Textul SMS pe care clientul tău îl va primi când comanda lui are starea: Plată eșuată', 'web-2-sms' ),
                    'type'        => 'textarea',
                    'desc'        => __('Scrie textul SMS-ului care se va trimite atunci cand o comanda este in stare "eșuată"', 'web-2-sms' ),
                    ...
                    'type'        => 'checkbox',
                    'desc'        => __('Bifeaza pentru trimiterea SMS daca o comanda este in starea "eșuată"', 'web-2-sms' ),
                    'id'          => 'wc_settings_web2sms_failed_status',
                    'default'     => 'no',
                    'css'         => '',
            ),
            'processing_sms_content' => array(
                    'name'        => __('Comanda in procesare', 'web-2-sms' ),
                    'placeholder' => '',
                    'desc_tip'    => __('Textul SMS pe care clientul tău îl va primi când comanda lui are starea: in Procesare', 'web-2-sms' ),
                    'type'        => 'textarea',
            ...
            'cancelled_sms_content' => array(
                    'name'        => __('Comandă anulată', 'web-2-sms' ),
                    'placeholder' => '',
                    'desc_tip'    => __('Textul SMS pe care clientul tău îl va primi când comanda lui are starea: Comandă anulată', 'web-2-sms' ),
                    'type'        => 'textarea',
                    'desc'        => __('Scrie textul SMS-ului care se va trimite atunci cand o comanda este in stare "anulată".', 'web-2-sms' ),
            ...
            'cancelled' => array(
                    ...
                    'type'        => 'checkbox',
                    'desc'        => __('Bifeaza pentru trimiterea SMS daca o comanda este in starea "anulată"', 'web-2-sms' ),
                    'id'          => 'wc_settings_web2sms_cancelled_status',
                    'default'     => 'no',
                    'css'         => '',
            ),
            'completed_sms_content' => array(
                    'name'        => __('Comandă finalizată', 'web-2-sms' ),
                    'placeholder' => '',
                    'desc_tip'    => __('Textul SMS pe care clientul tău îl va primi când comanda lui are starea: "finalizată"', 'web-2-sms' ),
                    'type'        => 'textarea',
                    'desc'        => __('Scrie textul SMS-ului care se va trimite atunci cand o comanda este in stare "finalizată"', 'web-2-sms' ),
            ...
            'completed' => array(
                    ...
                    'type'        => 'checkbox',
                    'desc'        => __('Bifeaza pentru trimiterea SMS daca o comanda este in starea "finalizată"', 'web-2-sms' ),
            ...
            'refunded_sms_content' => array(
                    ...
                    'placeholder' => '',
                    'desc_tip'    => __('Textul SMS pe care clientul tău îl va primi când comanda lui are starea: "Refunded"', 'web-2-sms' ),
                    'type'        => 'textarea',
            ...
            'intervalTime' => array(
                'name'      => __('Interval de timp', 'web-2-sms' ),
            ...
            'reminder_sms_content' => array(
                'name'        => __('Textul abandonat', 'web-2-sms' ),
                'placeholder' => __('Buna ziua! Nu uita că ai ceva în coș, dar încă nu ai finalizat comanda!', 'web-2-sms' ),
