...
class WC_Settings_Web2sms {
    ...
    public static function web2smsGetSettings() {
        $settings = array(
            'section_title' => array(
                    'name'     => __('Ce este Web2sms', 'web2sms' ),
                    'type'     => 'title',
                    ...
                    Pentru mai multe informati <a href="#" id="show_documention">Vazi documentație!</a>.', 'web2sms' ),
                    'id'       => 'wc_settings_tab_web2sms_section_title',
                    'css'       => '',
            ),
            'active' => array(
                    'name'        => __('Enable / Disable', 'web2sms' ),
                    'type'        => 'checkbox',
                    'desc'        => __('Bifeaza daca doresti trimiterea mesajelor de informare catre clientii tai.', 'web2sms' ),
                    'default'     => 'no',
                    'id'          => 'wc_settings_web2sms_active',
                    'css'         => '',
            ),
            'apikey' => array(
                    'name'        => __('Api key', 'web2sms' ),
                    'placeholder' => __('Cheia unica asociata contului tau web2sms.', 'web2sms' ),
                    'desc_tip'    => 'Api key de la web2sms.ro',
                    'type'        => 'text',
                    'desc'        => __('API cheia, se poate accesa din meniul Dashboard, in <a href="https://www.web2sms.ro/" target="_blank">www.web2sms.ro</a>', 'web2sms' ),
                    'id'          => 'wc_settings_web2sms_apikey',
                    'css'         => '',
            ),
            'secretkey' => array(
                    'name'        => __('Secret key', 'web2sms' ),
                    'placeholder' => __('Cheia secreta asociata contului tau web2sms.', 'web2sms' ),
                    'desc_tip'    => __('Secret key de la web2sms.ro', 'web2sms' ),
                    'type'        => 'text',
                    'desc'        => __('Cheia secreta, se poate accesa din meniul Dashboard, in <a href="https://www.web2sms.ro/" target="_blank">www.web2sms.ro</a>', 'web2sms' ),
                    'id'          => 'wc_settings_web2sms_secretkey',
                    'css'         => '',
            ),
            'pending_sms_content' => array(
                    'name'        => __('Pending text', 'web2sms' ),
                    'placeholder' => '',
                    'desc_tip'    => __('The sms text, what client will recive by sms on order status pending', 'web2sms' ),
                    'type'        => 'textarea',
                    'desc'        => __('Scrie textul SMS-ului care se va trimite atunci cand o comanda este in stare "Pending"', 'web2sms' ),
                    'id'          => 'wc_settings_web2sms_pending_text',
                    'css'         => '',
            ),
            'pending' => array(
                    'name'       => __('Pending', 'web2sms' ),
                    'desc_tip'   => '<button type="button" id="btn_pending" class="btn btn-lg btn-primary">'.__('vezi cum arata', 'web2sms' ).'</button>',
                    'type'       => 'checkbox',
                    'desc'       => __('Bifeaza pentru trimiterea SMS daca o comanda este in starea "Pending".', 'web2sms' ),
                    'id'         => 'wc_settings_web2sms_pending_status',
                    'default'    => 'no',
                    'css'        => '',
            ),
            'onhold_sms_content' => array(
                    'name'        => __('On-Hold text', 'web2sms' ),
                    'placeholder' => '',
                    'desc_tip'    => __('The sms text, what client will recive by sms on order status On-Hold', 'web2sms' ),
                    'type'        => 'textarea',
                    'desc'        => __('Scrie textul SMS-ului care se va trimite atunci cand o comanda este in stare "On-Hold"', 'web2sms' ),
                    'id'          => 'wc_settings_web2sms_on-hold_text',
                    'css'         => '',
            ),
            'onhold' => array(
                    'name'       => __('On-Hold', 'web2sms' ),
                    'desc_tip'   => '<button type="button" id="btn_onhold" class="btn btn-lg btn-primary">'.__('vezi cum arata', 'web2sms' ).'</button>',
                    'type'       => 'checkbox',
                    'desc'       => __('Bifeaza pentru trimiterea SMS daca o comanda este in starea "On-Hold"', 'web2sms' ),
                    'id'         => 'wc_settings_web2sms_on-hold_status',
                    'default'    => 'no',
                    'css'        => '',
            ),
            'failed_sms_content'  => array(
                    'name'        => __('Failed text', 'web2sms' ),
                    'placeholder' => '',
                    'desc_tip'    => __('The sms text, what client will recive by sms on order status Failed', 'web2sms' ),
                    'type'        => 'textarea',
                    'desc'        => __('Scrie textul SMS-ului care se va trimite atunci cand o comanda este in stare "Failed"', 'web2sms' ),
                    'id'          => 'wc_settings_web2sms_failed_text',
                    'css'         => '',
            ),'failed' => array(
                    'name'        => __('Faild', 'web2sms' ),
                    'desc_tip'    => '<button type="button" id="btn_failed" class="btn btn-lg btn-primary">'.__('vezi cum arata', 'web2sms' ).'</button>',
                    'type'        => 'checkbox',
                    'desc'        => __('Bifeaza pentru trimiterea SMS daca o comanda este in starea "Failed"', 'web2sms' ),
                    'id'          => 'wc_settings_web2sms_failed_status',
                    'default'     => 'no',
                    'css'         => '',
            ),
            'processing_sms_content' => array(
                    'name'        => __('Processing text', 'web2sms' ),
                    'placeholder' => '',
                    'desc_tip'    => __('The sms text, what client will recive by sms on order status processing', 'web2sms' ),
                    'type'        => 'textarea',
                    'desc'        => __('Scrie textul SMS-ului care se va trimite atunci cand o comanda este in stare "in Procesare".', 'web2sms' ),
                    'id'          => 'wc_settings_web2sms_processing_text',
                    'css'         => '',
            ),
            'processing' => array(
                    'name'       => __('Processing', 'web2sms' ),
                    'desc_tip'   => '<button type="button" id="btn_processing" class="btn btn-lg btn-primary">'.__('vezi cum arata', 'web2sms' ).'</button>',
                    'type'       => 'checkbox',
                    'desc'       => __(' Bifeaza pentru trimiterea SMS daca o comanda este in starea "in Procesare"', 'web2sms' ),
                    'id'         => 'wc_settings_web2sms_processing_status',
                    'default'    => 'no',
                    'css'        => '',
            ),
            'cancelled_sms_content' => array(
                    'name'        => __('Cancelled text', 'web2sms' ),
                    'placeholder' => '',
                    'desc_tip'    => __('The sms text, what client will recive by sms on order status Cancelled', 'web2sms' ),
                    'type'        => 'textarea',
                    'desc'        => __('Scrie textul SMS-ului care se va trimite atunci cand o comanda este in stare "Anulata".', 'web2sms' ),
                    'id'          => 'wc_settings_web2sms_cancelled_text',
                    'default'     => '',
                    'css'         => '',
            ),
            'cancelled' => array(
                    'name'        => __('Cancelled', 'web2sms' ),
                    'desc_tip'    => '<button type="button" id="btn_cancelled" class="btn btn-lg btn-primary">'.__('vezi cum arata', 'web2sms' ).'</button>',
                    'type'        => 'checkbox',
                    'desc'        => __('Bifeaza pentru trimiterea SMS daca o comanda este in starea "Anulata"', 'web2sms' ),
                    'id'          => 'wc_settings_web2sms_cancelled_status',
                    'default'     => 'no',
                    'css'         => '',
            ),
            'completed_sms_content' => array(
                    'name'        => __('Completed text', 'web2sms' ),
                    'placeholder' => '',
                    'desc_tip'    => __('The sms text, what client will recive by sms on order status "Completed"', 'web2sms' ),
                    'type'        => 'textarea',
                    'desc'        => __('Scrie textul SMS-ului care se va trimite atunci cand o comanda este in stare "Finalizata"', 'web2sms' ),
                    'id'          => 'wc_settings_web2sms_completed_text',
                    'css'         => '',
            ),
            'completed' => array(
                    'name'        => __('Completed', 'web2sms' ),
                    'desc_tip'    => '<button type="button" id="btn_completed" class="btn btn-lg btn-primary">'.__('vezi cum arata', 'web2sms' ).'</button>',
                    'type'        => 'checkbox',
                    'desc'        => __('Bifeaza pentru trimiterea SMS daca o comanda este in starea "Finalizata"', 'web2sms' ),
                    'id'          => 'wc_settings_web2sms_completed_status',
                    'default'     => 'no',
                    'css'         => '',
            ),
            'refunded_sms_content' => array(
                    'name'        => __('Refunded text', 'web2sms' ),
                    'placeholder' => '',
                    'desc_tip'    => __('The sms text, what client will recive by sms on order status "Refunded"', 'web2sms' ),
                    'type'        => 'textarea',
                    'desc'        => __('Scrie textul SMS-ului care se va trimite atunci cand o comanda este in stare "Creditata"', 'web2sms' ),
                    'id'          => 'wc_settings_web2sms_refunded_text',
                    'css'         => '',
            ),
            'refunded' => array(
                    'name'        => __('Refunded', 'web2sms' ),
                    'desc_tip'    => '<button type="button" id="btn_refunded" class="btn btn-lg btn-primary">'.__('vezi cum arata', 'web2sms' ).'</button>',
                    'type'        => 'checkbox',
                    'desc'        => __('Bifeaza pentru trimiterea SMS daca o comanda este in starea "Creditata"', 'web2sms' ),
            ...
            'abandoned_cart' => array(
                'title' => __('Abandoned cart', 'web2sms' ),
                'type'  => 'title',
                ...
                Mai jos poti configura trimiterea unui SMS pentru cosurile abandonate.', 'web2sms' ),
                'id' => 'wc_settings_tab_web2sms_section_abandoned_cart',
            ),
            'intervalTime' => array(
                'name'      => __('Interval Time', 'web2sms' ),
                'desc_tip'  => __('Send reminder after XX hour', 'web2sms' ),
                'default'   => '5',
                'type'      => 'number',
                ...
                'desc'      => __('Seteaza intervalul de timp (ore) cand se va trimite SMS-ul de reminder.', 'web2sms' ),
                'id'        => 'wc_settings_web2sms_interval_time',
                'css'       => 'width:100px;',
            ),
            'smsRetry' => array(
                'name'      => __('SMS Retry', 'web2sms' ),
                'desc_tip'  => __('Nr of sending reminder SMS', 'web2sms' ),
                'default'   => '1',
                'type'      => 'hidden',
                'custom_attributes' => array(
                    'min'  => 1,
                ...
                'desc'      => __('Nr of sending reminder SMS', 'web2sms' ),
                'id'        => 'wc_settings_web2sms_sms_retry',
                'css'       => 'width:100px;',
            ),
            'reminder_sms_content' => array(
                'name'        => __('reminder text', 'web2sms' ),
                'placeholder' => __('Salut! Nu uita ca ai ceva in cosul tau, dar nu ai finalizat comanda inca!', 'web2sms' ),
                'desc_tip'    => __('The sms text, what client will recive by sms on Abandoned cart', 'web2sms' ),
                'type'        => 'textarea',
                'desc'        => __('Scrie textul SMS-ului care se va trimite atunci cand "Cos abandonat"', 'web2sms' ),
                'id'          => 'wc_settings_web2sms_reminder_text',
                'css'         => '',
            ),
            'reminder' => array(
                'name'        => __('reminder', 'web2sms' ),
                'desc_tip'    => '<button type="button" id="btn_reminder" class="btn btn-lg btn-primary">'.__('vezi cum arata', 'web2sms' ).'</button>',
                'type'        => 'checkbox',
                'desc'        => __('Bifeaza daca doresti sa trimiteti SMS prentru cosuri "Abandonate".', 'web2sms' ),
